...
if (function_exists('imagettftext')) {
	...
	$dir = $_SERVER['DOCUMENT_ROOT'].'/include/captcha/fonts/';
	$image = imagecreatetruecolor(165, 30);
	// random number 1 or 2
	$num = rand(1,4);
	switch ($num) {
	  case 1 : $font = "capture.ttf"; break;
	  case 2 : $font = "moloto.otf";  break;
	  case 3 : $font = "walk_rounded.ttf"; break;
	  case 4 : $font = "walk_black.ttf"; break;
	  case 5 : $font = "young.ttf"; break;
	  case 6 : $font = "piaggo.ttf"; break;
	}
	// random number 1 or 2
	$num2 = rand(1,2);
	if($num2 == 1) {
  ...
  $_SESSION['random_number'] = rand_2_words();
	$image = imagecreatefrompng($_SERVER['DOCUMENT_ROOT'].'/include/captcha/button.png');
