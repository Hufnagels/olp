...
<!--
                <li class="slideElement" data-slide-type="template" data-template-type="input">
                  <div class="dataHolder isSelected">
                    <div class="pointer-left"></div>
                    <div class="leftSide">
                      <div class="ResizableClass textClass isSelected slideItem" style="left: 0.26666666666666666%; top: 1.4222222222222223%; width: 99%; height: auto; position: absolute;"><div class="movingBox"><i class="icon-move"></i></div>
                        <div id="myInstance_3_1" data-temp-id="3_1" contenteditable="true" class="textDiv" spellcheck="false" tabindex="0" style="position: relative;"><h1 style="text-align: center;">Ide jön a kérdés amit te teszel fel</h1></div>
                      </div>
                      <div class="ResizableClass textClass isSelected slideItem" style="position: absolute;top: 35.543706597222226%;left: 19.5%;width: 56%;height: auto;">
                        <div class="movingBox"><i class="icon-move"></i></div>
                        <div class="holder">
                          <div id="myInstance_3_2" data-temp-id="3_2" contenteditable="true" style="position: relative;" class="textDiv sortableForm" spellcheck="false" tabindex="0"></div>
                        </div>
                      </div>
                      <div class="buttonClass disabled" style="left: 87.13333333333333%; top: 91.25925925925927%; width: 12%; height: auto; position: absolute;" ><button type="button" id="submitForm" class="btn btn-dark btn-r">send</button></div>
                    </div>
                    <div class="rightSide"><span class="name">Felsorlás</span></div>
                  </div>
                </li>
-->
...
<li class="slideElement" data-slide-type="template" data-template-type="puzzle">
    <div class="dataHolder isSelected">
        <div class="pointer-left"></div>
        <div class="leftSide">
            <div class="ResizableClass textClass isSelected slideItem" style="left: 0.26666666666666666%; top: 1.4222222222222223%; width: 99%; height: auto; position: absolute;"><div class="movingBox"><i class="icon-move"></i></div>
                <div id="myInstance_7_1" data-temp-id="7_1" contenteditable="true" class="textDiv" spellcheck="false" tabindex="0" style="position: relative;"><h1 style="text-align: center;">Ide jön a kérdés amit te teszel fel</h1></div></div>
            <div class="buttonClass disabled" style="left: 87.13333333333333%; top: 91.25925925925927%; width: 12%; height: auto; position: absolute;" ><button type="button" id="submitForm" class="btn btn-dark btn-r">send</button></div>
        </div>
        <div class="rightSide"><span class="name">Puzzle</span></div>
    </div>
</li>
