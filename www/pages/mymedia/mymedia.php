<?php
    ...
    $quotaArray = Office::helperCalculateDiskUsage($_SESSION['office_id']);
    $quotaJsonArray = json_encode($quotaArray);
...
<form id="mymediaForm" action="#" method="POST" class="hidden">
...
<section id="inner-headline">
    <div class="container">
        <div class="row">
            <div class="span3">
                <div class="inner-heading">
                    <h2 id="linkData"><span class="pull-left" id="bc">View all</span></h2>
                </div>
            </div>
            <div class="span9">
                ...
                <div class="pull-right" id="sortingBar">
                    ...
                    <div class="pull-left">
                        <h3 class="functionHeader middlegreyT2">
                            <button class="btn btn-dark" id="addFiles">Add media</button>
                        </h3>
                    </div>
                </div>
                <!-- /ISOTOPE -->
        ...
        <div class="quotaDiv" style="position:relative;float:left;color:#252525;">
            <?
            if(!$quotaJsonArray){
                $total = $quotaArray['quota'] ? $quotaArray['quota'] : 1;
                $free = $quotaArray['free'];
                $usedpercent = $free/$total;
                echo '<div class="progress">';
                echo '<div class="bar bar-used" style="width: '.((1-$usedpercent)*100).'%;"></div>';
                echo '<div class="bar bar-free" style="width: '.($usedpercent*100).'%;"></div>';
                echo '</div>';
                echo '<div class="text">Total: '.$quotaArray['quotaMB'].' / Free: '.$quotaArray['freeMB'].'</div>';
            } else {
                echo '<div class="text" style="margin-left:5px;font-weight:800;">Unlimited Disk quota</div>';
            }
                    ...
                    <div class="Options well well-small">
                      <span class="functionHeader middlegreyT2">
                        ...
                        <div class="optionButtons">
                            ...
                            <button type="button" class="btn btn-dark btn-l disabled" data-option-value="removefrom"><span class="delete">Remove from</span></button>
                        </div>
                      </span>
                    </div>
                </div>
                    ...
                    <div class="inner">
                        ...
                        <form id="fileupload" action="#" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="fileupload-buttonbar">
                                <div class="1span2 pull-left"><button type="button" class="btn btn-l btn-dark" id="addVideoLink">add video link</button></div>
							...
							<div class="pull-left alert alert-info">
								...
								if(!$quotaJsonArray){
								?>
								Files left:<span id="filesLeft"></span>
								<? }?>
								<div class="">Max uploadsize: 100MB /per upload process</div>
							</div>
                            <div class="pull-right"><button type="button" class="btn btn-dark" id="uploadFinish"><span>Finish</span></button></div>
                        </form>
                        <!-- /UPLOAD FORM -->
                    </div>
                </div>
...
<script type="text/x-tmpl" id="tmpl-mediaElement">
    {% for (var i=0, file; file=o.result[i]; i++) { %}
    <li class="mediaElement span2 {%=file.type%}"
        ...
        <div class="optionBar">
            ...
            <span class="detailButton"><i class="icon-eye-open"></i></span>
        </div>
    </li>
    {% } %}
</script>
...
<script type="text/x-tmpl" id="tmpl-video">
    {% for (var i=0, file; file=o.result[i]; i++) { %}
    <iframe src="<?=$videodomain;?>videoloader/{%=file.name%}-{%=file.videoWidth%}-{%=file.videoHeight%}/" style="width: 100%; height: 100%;" frameborder="0" border="0" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreeniframe></iframe>
