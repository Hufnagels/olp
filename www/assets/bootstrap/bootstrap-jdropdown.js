...
console.log(trigger.offset().left + ' -- ' + hOffset );
		...
		dropdown
			.css({
				left: dropdown.hasClass('anchor-right') ? 
					trigger.offset().left + trigger.outerWidth() - (dropdown.outerWidth() ) + hOffset : trigger.offset().left + hOffset,
				top:  vOffset + trigger.outerHeight()//trigger.offset().top  + 
			})
			.show();
